...
public class BeeHiveParameters {
	...
	/** 工作范围参数：影响工作半径。默认值为 1.0，加法合并。 */
	public static final BeehiveParameterType<Float> RADIUS=BeeHiveParameterRegistry.registerNumeric(Beecrasy.rl("radius"),1f, (value,adder)->adder.accept(formatPercentageLanguage(Beecrasy.rl("radius"),value)));
