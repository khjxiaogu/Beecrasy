...
public class RoyalJellyRecipe extends ShapelessRecipe {
	   public static final MapCodec<RoyalJellyRecipe> MAP_CODEC = RecordCodecBuilder.mapCodec(
	        i -> i.group(
	...
	public RoyalJellyRecipe(CommonInfo commonInfo, CraftingBookInfo bookInfo) {
		super(commonInfo, bookInfo, new ItemStackTemplate(Items.QUEEN_BEE), List.of(Ingredient.of(Items.LARVA),Ingredient.of(Items.ROYAL_JELLY)));
	}
	public static RoyalJellyRecipe createDefault(boolean showNotification,CraftingBookCategory category, String group) {
