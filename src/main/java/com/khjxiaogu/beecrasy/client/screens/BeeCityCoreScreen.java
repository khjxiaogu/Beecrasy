 ...
 * </ul>
 */
public class BeeCityCoreScreen extends AbstractContainerScreen<BeeCityCoreMenu> {
	/** GUI 背景纹理位置 */
	static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(Beecrasy.MODID, "textures/gui/bee_city_core.png");

	public BeeCityCoreScreen(BeeCityCoreMenu menu, Inventory inventory, Component title) {
	...
	public void extractBackground(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
		...
		if (processMax > 0&&process>0) {
			...
			graphics.blit(RenderPipelines.GUI_TEXTURED, TEXTURE, leftPos + 116, topPos + 25 + h, 177, 0 + h, 4, 30 - h,256,256);
		}
