 ...
 * </ul>
 */
public class BeeCityQueenScreen extends AbstractContainerScreen<BeeCityQueenMenu> {
	/** GUI 背景纹理位置 */
	static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(Beecrasy.MODID, "textures/gui/bee_city_queen_cell.png");

	public BeeCityQueenScreen(BeeCityQueenMenu menu, Inventory inventory, Component title) {
	...
	public void extractBackground(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
		...
		if (processMax > 0&&process>0) {
			...
			graphics.blit(RenderPipelines.GUI_TEXTURED, TEXTURE, leftPos + 67, topPos + 25 + h, 177, 0 + h, 4, 30 - h,256,256);
		}
