...
public interface BakedPage {
	void extractRenderState(GuiGraphicsExtractor graphics, int x, int y, int w, int h,int viewY,int viewHeight, int mouseX, int mouseY, GuiInfoCollector tooltips);
	int height();
	/**
	 * @param graphics  
	 * @param x 
