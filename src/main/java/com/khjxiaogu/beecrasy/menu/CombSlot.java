...
public class CombSlot extends ResourceHandlerSlot {

	public CombSlot(ResourceHandler<ItemResource> handler, IndexModifier<ItemResource> slotModifier, int handlerSlot,
